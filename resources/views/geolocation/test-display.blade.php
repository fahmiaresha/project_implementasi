        ...
        <div>
            ...
            <nav aria-label="breadcrumb" class="d-flex align-items-start">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">TEST DISPLAY</li>
                </ol>
            </nav>
        </div>
</div>
...
<div class="row" >
    ...
    <div class="col-md-6 col-sm-6">
                                             ...
                                             <div class="data_tabel" id="data_tabel">
                                              <div class="card">
                                              <div class="card-body">
                                             
                                              <div id="demo2" style="height: 300px; position: relative; overflow: hidden; border: 1px solid gray;" onclick="getlocation()"> </div> 
                                            <br>
                                              ...
                                              <table class="table ">
                                                ...
                                                <th colspan="2" style="font-size:13px;"> Details Toko</th></center>
                                                </tr>
                                                </thead>
                                                <tbody>
                                                <tr>
                     ...
                     success:function(data)
                     {
                        ...
                        jQuery.each(data, function(key,value){
                          ...
                          var append_html = '\<div class="data_tabel" id="data_tabel">\
                            ...
                            // $("#kamera").hide();
                            // $("#tabel").addClass("col-md-6 col-sm-6"); 
