...
<div class="page-header d-md-flex justify-content-between">
    ...
    <div class="card">
        <div class="card-body">
        <form method="post" action="{{ url('/customer/store2') }}">
        @csrf
        @php $x=0; @endphp
        ...
        @endforeach
        @php $y=$x+1; @endphp
        <input type="hidden" name="nama_foto" value="{{$y}}">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name ="alamat" id="formGroupExampleInput" placeholder="Alamat" >
